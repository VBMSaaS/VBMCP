/*
 ...
 Date: 18/11/2025 15:41:01
*/


-- ----------------------------
-- Table structure for vb_openapi_table_usage
-- ----------------------------
DROP TABLE IF EXISTS "vb_saas"."vb_openapi_table_usage";
CREATE TABLE "vb_saas"."vb_openapi_table_usage" (
  ...
  "ordinal" int4 NOT NULL DEFAULT nextval('"vb_saas".vb_openapi_table_usage_ordinal_seq'::regclass),
  "create_at" timestamptz(6) NOT NULL DEFAULT now(),
  "last_update" timestamptz(6) NOT NULL DEFAULT now(),
  "res_name_fake" varchar(200) COLLATE "pg_catalog"."default"
)
;
